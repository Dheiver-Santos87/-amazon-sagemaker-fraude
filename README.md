![Jornada do Zero ao Deploy](images/Santos.png)
...
6. *Inferência e Armazenamento de Recursos Online*: Para inferência em tempo real, podemos aproveitar uma Armazenamento de Recursos da AWS online que criamos para obter latência de um dígito em milissegundos e alta taxa de transferência para atender nosso modelo com novos dados de entrada.
